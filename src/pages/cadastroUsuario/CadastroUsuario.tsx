                ...
                <Box paddingX={10}>
                    <form onSubmit={onSubmit}>
                            ...
                            <Box marginTop={2} textAlign="center">
                                    ...
                                    <Button type="submit" variant="contained"  className="btnCancelar primaryBackground" >Cadastrar</Button>
                                
                                <Link to="/login" className="text-decorator-none ">
                                    <Button variant="contained" className="secondaryBackground" >Cancelar</Button>
                                </Link>
                            </Box>
                    </form>
                </Box>
